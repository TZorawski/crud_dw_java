    ...
    <body>
        ...
        <form method="post" action="CandidatoServlet" class="form-horizontal">
            ...
            <div class="form-group"><label class="col-sm-1 control-label">Data Nascimento</label>
                <div class="col-sm-6"><input type="text" name="data_nascimento" class="form-control"/></div></div>
            ...
            <div class="form-group"><label class="col-sm-1 control-label">Habilidades</label>
                <div class="col-sm-7 col-sm-offset-1">
                    ...
                    for (Habilidade hab : habs) {
                        //Insere essa linha na pagina html
        ...
        <div class="col-sm-7 col-sm-offset-1">
            ...
            <form method="post" action ="CandidatoServlet" class="form-inline">
                <div class="form-group"><div class="col-sm-2"><input type="text" name="busca" class="form-control"/></div>
                    <input type="submit" name="op" value="Buscar" class="btn btn-primary"/></div>
            </form>
